    ...
    return (
      <Fragment>
          ...
          <div className="EventInfo__in">
            ...
            <div className="EventInfo__footer">
              ...
              <Button size="xl" onClick={() => {
				...
				fetch('https://2936e8048862.ngrok.io/api/v1/task/detail/'+event.id, {method: 'PUT', // Method itself
																			 headers: {
        ...
        console.log(global.vlt[global.vlt_i].karma)
				fetch('https://2936e8048862.ngrok.io/api/v1/task/getlist/?format=json')
